classdef myHelperAMCLVisualization < handle
    ...
    methods
        function obj = myHelperAMCLVisualization(og)
        ...
        function plotStep(obj, amclMCLObj, amclSensorModel, estimatedPose, scan, numUpdates)
            ...
            [particles, ~] = robotics.algs.internal.AccessMCL.getParticles(amclMCLObj);
